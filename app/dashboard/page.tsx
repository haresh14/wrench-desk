      ...
      <div className="p-6 lg:p-8 max-w-7xl mx-auto">
        <div className="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-zinc-600 mt-1">Here&apos;s what&apos;s happening with your business today.</p>
          </div>
          <div className="text-sm font-medium text-zinc-500 bg-zinc-100 px-4 py-2 rounded-xl border border-zinc-200">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-8">
          <Card className="border-zinc-200 shadow-sm hover:shadow-md transition-shadow">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-bold text-zinc-500 uppercase tracking-wider">Today&apos;s Jobs</CardTitle>
              <div className="p-2 bg-indigo-50 rounded-lg">
                <Calendar className="w-4 h-4 text-indigo-600" />
              </div>
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-black text-zinc-900">{todayJobs?.length || 0}</div>
          ...
          <Card className="border-zinc-200 shadow-sm hover:shadow-md transition-shadow">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-bold text-zinc-500 uppercase tracking-wider">Active Customers</CardTitle>
              <div className="p-2 bg-blue-50 rounded-lg">
                <Users className="w-4 h-4 text-blue-600" />
              </div>
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-black text-zinc-900">{customerCount || 0}</div>
          ...
          <Card className="border-zinc-200 shadow-sm hover:shadow-md transition-shadow">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-bold text-zinc-500 uppercase tracking-wider">Unpaid Invoices</CardTitle>
              <div className="p-2 bg-amber-50 rounded-lg">
                <FileText className="w-4 h-4 text-amber-600" />
              </div>
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-black text-zinc-900">{unpaidInvoices?.length || 0}</div>
          ...
          <Card className="border-zinc-200 shadow-sm hover:shadow-md transition-shadow">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-bold text-zinc-500 uppercase tracking-wider">Revenue (MTD)</CardTitle>
              <div className="p-2 bg-emerald-50 rounded-lg">
                <DollarSign className="w-4 h-4 text-emerald-600" />
              </div>
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-black text-zinc-900">${monthlyRevenue.toLocaleString()}</div>
              <p className="text-xs font-medium text-emerald-600 mt-1 flex items-center gap-1">
                <ArrowUpRight className="w-3 h-3" />
                On track for growth
              </p>
          ...
          <Card className="lg:col-span-2 border-zinc-200 shadow-sm">
            <CardHeader className="border-b border-zinc-50">
              <div className="flex items-center justify-between">
                <CardTitle className="text-lg font-bold text-zinc-900">Upcoming Schedule</CardTitle>
            ...
            <CardContent className="p-0">
              {upcomingJobs && upcomingJobs.length > 0 ? (
                ...
                <div className="py-12 text-center">
                  ...
                  <h3 className="font-bold text-zinc-900">No upcoming jobs</h3>
                  <p className="text-zinc-500 text-sm mt-1">Your schedule is clear for now.</p>
                </div>
              )}
            </CardContent>
          </Card>
            ...
            <CardContent className="p-0">
              {recentInvoices && recentInvoices.length > 0 ? (
                ...
                <div className="py-12 text-center">
                  ...
                  <h3 className="font-bold text-zinc-900">No recent activity</h3>
                  <p className="text-zinc-500 text-sm mt-1">Activity will appear here as you work.</p>
                </div>
              )}
            </CardContent>
          </Card>
