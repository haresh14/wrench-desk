    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            <label htmlFor="customer_id" className="block text-sm font-medium text-zinc-700 mb-1">
              Customer
            </label>
            <select
              id="customer_id"
          ...
          <div>
            <label htmlFor="scheduled_time" className="block text-sm font-medium text-zinc-700 mb-1">
              Scheduled Time
            </label>
            <input
              id="scheduled_time"
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label htmlFor="job_type" className="block text-sm font-medium text-zinc-700 mb-1">
                Job Type
              </label>
              <input
                id="job_type"
          ...
          <div>
            <label htmlFor="technician_name" className="block text-sm font-medium text-zinc-700 mb-1">
              Technician
            </label>
            <input
              id="technician_name"
